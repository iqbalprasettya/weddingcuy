  ...
  if ($gallery_image_size > 2097152) {
    ...
    if ($gallery_image_name != "") {
      ...
      if (in_array($ekstensi, $ekstensi_izin) === true) {
        ...
        $query = mysqli_query($koneksi2, "INSERT INTO gallery VALUES ('', '$gallery_heading',  '$gallery_desc', '$gallery_image_name_new')");
      ...
      $query = mysqli_query($koneksi2, "INSERT INTO gallery( gallery_heading, gallery_desc) VALUES ('$gallery_heading', '$gallery_desc')");
