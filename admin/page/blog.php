    ...
    <div class="row">
        ...
        ?>
            <div class="blog-item col-md-3 card">
                ...
                <div class="card-body">
                    <div class="author">
                        <p><span>23 Jan 2020</span> / iqbalalala</p>
                    </div>
                    <h5 class="card-title"><?php echo $row['blog_heading']; ?></h5>
                    <p class="card-text"><?php echo $row['blog_text']; ?></p>
                    <a href="index.php?page=edit-blog&id=<?php echo $row['id']; ?>" class="btn btn-success btn-sm"><i class="bi bi-pencil-square"></i></a>
                    <a href="../action.php?act=delete-blog&id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm"><i class="bi bi-trash-fill"></i></a>
                </div>
            </div>
